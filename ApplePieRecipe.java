public class ApplePieRecipe {
    ...
    Ingredient zoetZureAppels = new Ingredient(1.5, "gram", "zure appels");
...
public void klopEiLos(){
    System.out.println("Klop het ei los en verdeel deze in twee delen. De ene helft is voor het deeg, het andere deel is voor het bestrijken van de appeltaart.");
}
public void mengIngredienten(){
...
public void prepareerSpringvorm(){
    System.out.println("Vet de springvorm in en bestrooi deze met bloem");
}
public void bedekBodemVorm(){
...
public void deegSnijden(){
    System.out.println("Rol het laatste deel van de deeg uit tot een dunne lap en snij stroken van ongeveer 1 cm breed.");
}
public void strokenLeggen(){
